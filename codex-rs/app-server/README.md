...
{ "method": "command/exec", "id": 32, "params": {
    "command": ["ls", "-la"],
    "environmentId": "local",                     // optional; currently only local command starts are supported
        ...
        "skills": [
            {
              ...
              "qualifiedPath": "oai_env://local/Users/me/.codex/skills/skill-creator/SKILL.md",
              "enabled": true,
              "interface": {
