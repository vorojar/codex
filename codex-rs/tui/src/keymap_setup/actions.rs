...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("unified_mentions", "Mentions", "toggle_remember_search_mode", "Remember or forget the selected mentions search mode."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("unified_mentions", "toggle_remember_search_mode") => Some(&mut keymap.unified_mentions.toggle_remember_search_mode),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("unified_mentions", "toggle_remember_search_mode") => Some(runtime_keymap.unified_mentions.toggle_remember_search_mode.as_slice()),
