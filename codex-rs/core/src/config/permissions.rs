...
pub(crate) fn builtin_permission_profile(profile_name: &str) -> Option<PermissionProfile> {
    match profile_name {
...
pub(crate) fn compile_permission_profile_selection(
    ...
    if let Some(permission_profile) = builtin_permission_profile(profile_name) {
