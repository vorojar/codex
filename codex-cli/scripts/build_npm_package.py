...
PACKAGE_METADATA = SCRIPT_DIR / "package_metadata.py"
...
CODEX_PLATFORM_PACKAGES = getattr(_METADATA_MODULE, "CODEX_PLATFORM_PACKAGES", {})
PACKAGE_CHOICES = getattr(_METADATA_MODULE, "PACKAGE_CHOICES", ())
PACKAGE_EXPANSIONS = getattr(_METADATA_MODULE, "PACKAGE_EXPANSIONS", {})
PACKAGE_NATIVE_COMPONENTS = getattr(_METADATA_MODULE, "PACKAGE_NATIVE_COMPONENTS", {})
PACKAGE_TARGET_FILTERS = getattr(_METADATA_MODULE, "PACKAGE_TARGET_FILTERS", {})
